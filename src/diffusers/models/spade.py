...
class SPADE(nn.Module):
    def __init__(self, norm_nc, label_nc, config_text='spadeinstance3x3'):
        ...
        # self.conv_up_channel_guidance = nn.Conv2d(label_nc, norm_nc, kernel_size=ks, padding=pw)
    ...
    def forward(self, x_dic, segmap_dic, size=None):
        ...
        # segmap = F.interpolate(segmap, size=x.size()[2:], mode='nearest') # 이거 킬까말까 고민!!!
...
class zs_scale(nn.Module):
    def __init__(self, norm_nc, label_nc, config_text='spadeinstance3x3'):
        ...
        self.param_free_norm = normalization(norm_nc, 4)
