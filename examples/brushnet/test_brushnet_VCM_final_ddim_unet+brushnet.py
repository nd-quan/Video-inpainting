# CUDA_VISIBLE_DEVICES=0 python /media/ssd2/naeun/BrushNet/examples/brushnet/test_brushnet_VCM_final_ddim_unet+brushnet.py
...
output_dir='/media/ssd2/naeun/NAS_NE/Result/result/brushnet/COCO/train_both/test/1200000'
...
unet_path="/media/ssd2/naeun/save/checkpoint/Checkpoint_brushnet_512_unet/checkpoint-1200000/unet"
blended = True
...
trained_unet = UNet2DConditionModel.from_pretrained(unet_path, torch_dtype=torch.float16)
