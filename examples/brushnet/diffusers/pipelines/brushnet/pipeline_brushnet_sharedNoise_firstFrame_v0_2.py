...
class StableDiffusionBrushNetPipeline(
    ...
    def __call__(
        ...
        shared_bg_noise_strength: float = 0.0,
        reset_shared_bg_noise: bool = False,
        ...
        **kwargs,
        ...
        if shared_bg_noise_strength > 0.0 and (use_shared_bg_noise or shared_bg_noise is not None):
            ...
            if shared_bg_noise is None:
                ...
                if ( 
                    ...
                    cached_shared_bg_noise = noise[:1].detach().clone()
                    self._cached_shared_bg_noise = cached_shared_bg_noise
                shared_bg_noise = cached_shared_bg_noise
...
# ''' StableDiffusionBrushNetPipeline_v02 (naeun- use the fusion BG and ROI) 
