...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin, PeftAdapterMixin):
    ...
    def __init__(
        ...
        self.brush_spade_pre = SPADE(
        norm_nc=block_out_channels[0],
        label_nc=block_out_channels[0],
        config_text="spadeinstance3x3",
        )

        self.brush_spade_mid = SPADE(
            norm_nc=block_out_channels[-1],
            label_nc=block_out_channels[-1],
            config_text="spadeinstance3x3",
        )
    ...
    def forward(
        ...
        if is_brushnet:
            ...
            cond = mid_block_add_sample
            sample = self.brush_spade_pre(sample, cond)
        ...
        if is_brushnet:
            ...
            cond = mid_block_add_sample
            sample = self.brush_spade_mid(sample, cond)
