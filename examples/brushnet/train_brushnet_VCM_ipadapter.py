# brushnet은 frozen하고 ipadapter 훈련함 (이떄 UNet에 각각 결합되게)
#!/usr/bin/env python
# coding=utf-8
# conda : diffusers
import argparse
...
def main(args):
    ...
    # # 나은 디버깅용###################### 
    # ip_count = sum(isinstance(p, IPAttnProcessor) for p in unet.attn_processors.values())
    # all_count = len(unet.attn_processors)
    # print("원하는 디버깅!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    # print("ip processors:", ip_count, "/", all_count)
