...
from VCMCrossAttention import BiDirCrossAttentionVCM
...
def main(args):
    ...
    # v1.2 초기화
    fuser = BiDirCrossAttentionVCM(in_ch=4, d_model=64, nhead=4).to(accelerator.device)
    ...
    if args.resume_from_checkpoint:
        ...
        if path is None:
            ...
            accelerator.load_state(os.path.join(args.output_dir, path),map_location="cpu",strict=False)
