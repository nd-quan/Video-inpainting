...
def main(args):
    ...
    train_dataset = CustomDataset(
        ...
        captions_file="/home/gpu_03/nas_naeun/data/data/caption/train/COCO_train_caption.txt",
        # captions_file="/media/hdd/naeun/dataset/caption/COCO_train_caption.txt",
        gt_folder="/home/gpu_03/nas_naeun/data/data/New/gt_COCO",
        synthesis_folder = "/home/gpu_03/nas_naeun/data/data/New/synthesis_COCO",
        mask_folder="/home/gpu_03/nas_naeun/data/data/New/mask_COCO",
        tokenizer=tokenizer,
    )
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(ip_adapter,brushnet):
                ...
                with torch.no_grad():
                    image_embeds = image_encoder(batch["clip_images"].to(accelerator.device, dtype=weight_dtype)).image_embeds # [6.1024]
                ...
                image_embeds_ = []
                for fused_embed, drop_image_embed in zip(fused_image_embeds, batch["drop_image_embeds"]):
                    if drop_image_embed == 1:
                        image_embeds_.append(torch.zeros_like(fused_embed))
                    else:
                        image_embeds_.append(fused_embed)
