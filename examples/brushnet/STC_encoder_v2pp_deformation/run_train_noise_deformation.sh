...
BASELINE_CHECKPOINT="${BASELINE_CHECKPOINT:-${BRUSHNET_ROOT}/experiments/train_sharedNoise_sameBG_0.95_T8/checkpoint-2000}"
STC_V2_CHECKPOINT="${STC_V2_CHECKPOINT:-${BRUSHNET_ROOT}/experiments/train_rgb_stc_v2_sharedNoise_0.95/checkpoint-1250/stc_adapter}"
OUTPUT_DIR="${OUTPUT_DIR:-${BRUSHNET_ROOT}/experiments/train_stc_v2pp_noise_deformation_full_0.95_T16}"
