...
output_dir='/media/ssd1/ndquan/model_naeun/paper/BrushNet/Quan_test/results/Generated_image/PartyScene_long/new/sharedNoise_fixedBG_CGE_v0_2'
...
for orig_idx, image_path, mask_path, caption in tqdm(indexed_pending, total=len(indexed_pending)):
    ...
    pipe.scheduler.x_lr = image_transform(init_image).unsqueeze(0).to(device=device)
