...
# from diffusers.pipelines.brushnet.pipeline_brushnet_sharedNoise_v0 import StableDiffusionBrushNetPipeline
...
output_dir='/media/ssd1/ndquan/model_naeun/paper/BrushNet/Quan_test/results/Generated_image/PartyScene_long/frameBase'
