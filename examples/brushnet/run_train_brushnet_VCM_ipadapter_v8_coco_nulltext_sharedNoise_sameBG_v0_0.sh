...
INITIAL_CHECKPOINT="${INITIAL_CHECKPOINT:-/home/cilab/ndquan/videoInpainting/code/BrushNet/examples/checkpoint_brushnet/checkpoint-2000-sharednoise-0.7}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/cilab/ndquan/videoInpainting/code/BrushNet/examples/checkpoint_brushnet/train_sharedNoise_sameBG_0.9}"
...
SHARED_BG_NOISE_STRENGTH="${SHARED_BG_NOISE_STRENGTH:-1.0}"
