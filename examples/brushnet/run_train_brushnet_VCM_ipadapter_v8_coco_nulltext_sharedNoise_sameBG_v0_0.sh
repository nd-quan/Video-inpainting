...
INITIAL_CHECKPOINT="${INITIAL_CHECKPOINT:-/home/cilab/ndquan/NAS_ndq/model_base/Checkpoint/fine-tuning-v8/checkpoint-2000}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/cilab/ndquan/NAS_ndq/model_base/Checkpoint/train_sharedNoise_sameBG_v0_0}"
