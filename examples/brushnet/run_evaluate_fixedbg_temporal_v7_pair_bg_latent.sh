#!/usr/bin/env bash
# Latent-space counterpart of the V7-flow / pair-BG temporal-guidance run.
...
OUTPUT_ROOT="${OUTPUT_ROOT:-${BRUSHNET_ROOT}/experiments/eval_fixedbg_temporal_v7_pair_bg_latent}"
